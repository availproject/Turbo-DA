...
const ReclaimCredits = ({
  ...
  return (
    ...
    >
      <DialogContent className="min-w-[600px] h-[600px] border bg-linear-[90deg] from-bg-primary from-[0%] to-bg-secondary to-[100%] shadow-primary border-border-grey rounded-2xl overflow-hidden p-0 flex flex-col focus-within:outline-0">
