...
import { ChevronLeft, ChevronRight, Copy, InfoIcon } from "lucide-react";
              ...
              <TableRow key={index} className="hover:bg-transparent">
                ...
                <TableCell className="font-mono">
                  <div className="flex items-center space-x-2">
                    <span>
                      {token.token_address.substring(0, 4)}...
                      {token.token_address.slice(-3)}
                    </span>
                    <Button
                      variant="ghost"
                      size="icon"
                ...
                <TableCell className="text-right">
                  <span className="whitespace-nowrap">
                    {" "}
                    {token.token_balance} {token.token_ticker}
                  </span>
                </TableCell>
                <TableCell className="text-right">
                  <span className="whitespace-nowrap">
                    {" "}
                    {token.token_used} {token.token_ticker}
                  </span>
                </TableCell>
              </TableRow>
            ))
