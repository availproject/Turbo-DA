    ...
    return (
      <div className="pl-2">
        ...
        <Dialog open={openDialog} onOpenChange={setOpenDialog}>
          ...
          <DialogContent className="bg-[#131313] border-0 flex flex-col items-center justify-center !rounded-xl !bg-opacity-100">
            <DialogHeader>
              ...
              <DialogDescription>
                <p className="mb-4">
                  Update your AppID to enable the data submission script to work
        ...
        <div className="text-opacity-60 text-white pb-6">
          <p className="mb-4">
            You can use this API key to submit data. We&apos;ll fund your data
            credit based on this key.
          </p>
              ...
              <div className="space-y-4">
                <Alert className="border-yellow-500/50 bg-yellow-500/10">
                  <AlertDescription className="text-yellow-200">
                    Important: This API key will only be shown once. Please copy
