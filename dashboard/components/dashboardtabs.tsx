...
export default function DashboardTabs() {
  ...
  return (
    ...
    >
      <div className="text-mono text-white text-opacity-90 pt-2 pb-6 flex flex-row items-start justify-start space-x-2"><InfoIcon className="w-4 h-4 mt-1"/><p>This is the dashboard for your TurboDA Account, you can set up your AppId, copy your api-key and see credits here. (In Bytes)</p></div>
      <Credit/> 
          <UpdateAppId/>
